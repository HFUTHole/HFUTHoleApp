  ...
  return (
    <View className={'flex-row space-x-2'}>
      ...
      <View className={'flex-1'}>
        ...
        >
          还没有简介哦 还没有简介哦 还没有简介哦 还没有简介哦 还没有简介哦
          还没有简介哦
        </Text>
      </View>
      <View>
        <TouchableRipple onPress={() => setViewMore(!viewMore)}>
...
export function ProfileScreen() {
  ...
  const { data: postData } = useUserPostedHoleList()
  const { data: favData } = useUserFavoriteHoleList()
    ...
    <LoadingScreen isLoading={false}>
      ...
      >
        <Image
          ...
          source={{
            // TODO: 替换占位图
            uri: 'https://www.hfut.edu.cn/__local/D/2E/EF/29B4ADF12742C9B1A9EAE03E811_6E3BC861_4C2103.png',
          }}
          ...
          <Animated.View className={'px-[2.5vw] space-y-4 mb-4 '} style={{}}>
            <View className={'flex-row justify-around align-center ml-[120]'}>
              ...
              >
                ...
                >
                  {postData?.pages[0].meta.totalItems}
                </Text>
              ...
              >
                <Text
                  className={'text-center text-black font-bold text-[20px]'}
                >
                  {favData?.pages[0].meta.totalItems}
                </Text>
                <Text className={'text-center text-black/80 text-[16px]'}>
                  喜欢
                </Text>
